...
<div class="overflow-x-auto mb-20">
  ...
  <div class="border-b-2 border-slate-400">
    <p class="text-4xl my-4 ml-8">post categories</p>
  </div>
        ...
        <th>
          <div class="flex gap-2">
            ...
            <form action="/dashboard/categories/{{ $category->slug }}" method="category">
              @method('delete')
              @csrf
              <button class="btn btn-xs font-bold" type="submit"
  ...
  <div class="ml-4 mt-4">
    <a class="btn btn-neutral" href="/dashboard/categories/create">create new category</a>
  </div>
