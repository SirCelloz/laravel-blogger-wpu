  ...
  <form action="/dashboard/posts" method="post" enctype="multipart/form-data">
    ...
    <div>
      ...
      <div class="my-6">
        ...
        <input type="text" class="input input-bordered w-3/4 @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required>
        @error('title')
      ...
      <div class="my-6">
        ...
        <input type="text" class="input input-bordered w-3/4 input-disabled cursor-text @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug') }}" required placeholder="ur slug">
        @error('slug')
        <div role="alert" class="alert alert-warning p-2 w-3/4 my-3">
          <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
          <span>{{ $message }}</span>
      ...
      <div class="my-6">
        ...
        <img class="img-preview my-3 max-h-96">
      ...
      <div class="card-actions justify-start">
        <button class="btn btn-neutral px-8" type="submit">create</button>
      </div>
    </div>
  </form>
